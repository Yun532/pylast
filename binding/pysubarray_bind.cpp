...
void bind_subarray_description(nb::module_ &m)
{
    ...
    nb::class_<CameraReadout>(m, "CameraReadout")
        ...
        .def_ro("waveform_sample_unit", &CameraReadout::waveform_sample_unit)
        .def_ro("single_pe_area_mv_ns", &CameraReadout::single_pe_area_mv_ns)
        .def_ro("template_time_reference", &CameraReadout::template_time_reference)
